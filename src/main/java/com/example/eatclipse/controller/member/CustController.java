...
public class CustController {
	...
	@RequestMapping("shopInfo/{shop_name}")     
	// PathVariable 쓰려면 {shop_name}으로 해야함.
	// 그런데 문제는 각 카테고리마다 식당 수도 다르고, 유동적으로 변해야 함.
	// 어케 해?ㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋㅋ
	public ModelAndView menuList(@PathVariable("shop_name") String shop_name,
			@RequestParam int no, HttpSession session, ModelAndView mav) {
