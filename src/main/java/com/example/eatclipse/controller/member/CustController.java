...
public class CustController {
	...
	public ModelAndView list(@PathVariable("type") int type, ModelAndView mav) {
		...
		if(type == 2)mav.addObject("list", custDAO.koreanList(type));
		else if(type == 3)mav.addObject("list", custDAO.westernList(type));
		else if(type == 4)mav.addObject("list", custDAO.bunsickList(type));
		else if(type == 5)mav.addObject("list", custDAO.chineseList(type));
		else if(type == 6)mav.addObject("list", custDAO.japaneseList(type));
		else if(type == 7)mav.addObject("list", custDAO.disertList(type));
		else if(type == 8)mav.addObject("list", custDAO.fastfoodList(type));
